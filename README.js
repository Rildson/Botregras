...
function message(){
var m, msgs;
msgs = ["/me Proibido o uso do Caps Lock/ Siga as regras da sala/ Evite pedir fans e cargos, obrigado por sua preferência de sala / Prohibited the use of the Caps Lock / Follow the rules of the room / Avoid asking fans and posts, thank you for your preference", "/me Em caso de Dúvidas chame algum membro da staff, estamos sempre dispostos a ajudar/If in doubt call a member of staff, we are always willing to help ;) !", "/me Oi Bem vindo a sala, Divirta Se/Hi Welcome to room, If fun :P , Regras/Rules https://docs.google.com/document/d/1DBE2hr_cwb23b0llZtrzrlePha-hdlAMHFvVYG4T-lo/pub ", "/me É novo na sala, Monte seu playlist e venha compartilhar seu som conosco/New to room, Mount your playlist and come share with us their sound ! :))", "/me Mantenha o respeito com todos, Evite constrangimentos/Maintain compliance with all constraints Avoid ;P !"];
